...
from corpus_base.models import tipo_documento, fuente, zonas, subzonas, temas, documentos, lemas, clases_de_palabras, determinante_1, determinante_2, determinante_3, determinante_4, casos, provincias
